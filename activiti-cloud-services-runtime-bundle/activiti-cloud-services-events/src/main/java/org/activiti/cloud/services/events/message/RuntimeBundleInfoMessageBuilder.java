...
public class RuntimeBundleInfoMessageBuilder implements MessageChannelMessageBuilder {

    private final RuntimeBundleProperties properties;

    public RuntimeBundleInfoMessageBuilder(RuntimeBundleProperties properties) {
