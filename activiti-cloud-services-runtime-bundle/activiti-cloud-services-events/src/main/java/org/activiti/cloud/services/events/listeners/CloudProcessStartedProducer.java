...
public class CloudProcessStartedProducer implements ProcessEventListener<ProcessStartedEvent> {
    ...
    public CloudProcessStartedProducer(ToCloudProcessRuntimeEventConverter eventConverter,
